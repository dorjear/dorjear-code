 ...
 *
 * This class manages the state for the marketplace view in the Dorjear Code extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Dorjear Code extensions interface
...
import { MarketplaceItem } from "@dorjear-code/types"
