...
### 3. Dorjear Code Topluluğuna Katıl
...
- **Mevcut issue'ları kontrol et:** [GitHub Issues](https://github.com/RooCodeInc/dorjear-code/issues)'da ara.
...
- Dokümantasyon için [Dorjear Code Docs](https://github.com/RooCodeInc/dorjear-code-Docs)'u ziyaret et.

### Hata veya Sorun Bildirme

- Önce mevcut raporları kontrol et.
- ["Bug Report" şablonu](https://github.com/RooCodeInc/dorjear-code/issues/new/choose) kullanarak yeni hata raporları oluştur.
- **Güvenlik açıkları:** [security advisories](https://github.com/RooCodeInc/dorjear-code/security/advisories/new) aracılığıyla özel olarak bildir.
...
```
git clone https://github.com/KULLANICI_ADIN/dorjear-code.git
```
...
Pull request göndererek, katkılarının Dorjear Code'un lisanslamasıyla tutarlı olarak Apache 2.0 Lisansı altında lisanslanacağını kabul etmiş olursun.
