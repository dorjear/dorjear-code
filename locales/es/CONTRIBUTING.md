...
### 3. Únete a la Comunidad Dorjear Code
...
- **Revisar issues existentes**: Busca en [GitHub Issues](https://github.com/RooCodeInc/dorjear-code/issues).
...
- Para documentación, visita [Dorjear Code Docs](https://github.com/RooCodeInc/dorjear-code-Docs).

### Reportar Errores

- Primero verifica si ya existen reportes.
- Crea nuevos reportes de errores usando la [plantilla "Bug Report"](https://github.com/RooCodeInc/dorjear-code/issues/new/choose).
- **Problemas de seguridad**: Reporta de forma privada a través de [security advisories](https://github.com/RooCodeInc/dorjear-code/security/advisories/new).
...
```
git clone https://github.com/TU_USUARIO/dorjear-code.git
```
...
Al contribuir, aceptas que tus contribuciones serán licenciadas bajo la Licencia Apache 2.0, consistente con la licencia de Dorjear Code.
