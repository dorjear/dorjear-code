...
### 3. Dołącz do społeczności Dorjear Code
...
- **Sprawdź istniejące issues:** Przeszukaj [GitHub Issues](https://github.com/RooCodeInc/dorjear-code/issues).
...
- W kwestii dokumentacji odwiedź [Dorjear Code Docs](https://github.com/RooCodeInc/dorjear-code-Docs).

### Zgłaszanie błędów

- Najpierw sprawdź istniejące zgłoszenia.
- Twórz nowe zgłoszenia błędów używając [szablonu "Bug Report"](https://github.com/RooCodeInc/dorjear-code/issues/new/choose).
- **Luki bezpieczeństwa:** Zgłaszaj prywatnie przez [security advisories](https://github.com/RooCodeInc/dorjear-code/security/advisories/new).
...
```
git clone https://github.com/TWÓJ_UŻYTKOWNIK/dorjear-code.git
```
...
Zgłaszając pull request, zgadzasz się, że twój wkład będzie licencjonowany na licencji Apache 2.0, zgodnie z licencją Dorjear Code.
