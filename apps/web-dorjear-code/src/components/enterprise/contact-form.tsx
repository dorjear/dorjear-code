...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping Dorjear Code's enterprise solution."
			: "Fill out the form below to see Dorjear Code's enterprise capabilities in action."
