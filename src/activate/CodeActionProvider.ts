...
import { CodeActionName, CodeActionId } from "@dorjear-code/types"
...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with Dorjear Code",
	FIX: "Fix with Dorjear Code",
	IMPROVE: "Improve with Dorjear Code",
	ADD_TO_CONTEXT: "Add to Dorjear Code",
	NEW_TASK: "New Dorjear Code Task",
} as const
