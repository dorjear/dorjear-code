...
import { CloudService, getRooCodeApiUrl } from "@dorjear-code/cloud"
	...
	*/
	...
	async ensureMcpServersDirectoryExists(): Promise<string> {
		...
		if (process.platform === "win32") {
			// Windows: %APPDATA%\dorjear-code\MCP
			mcpServersDir = path.join(os.homedir(), "AppData", "Roaming", "dorjear-code", "MCP")
		} else if (process.platform === "darwin") {
			// macOS: ~/Documents/Cline/MCP
			mcpServersDir = path.join(os.homedir(), "Documents", "Cline", "MCP")
		} else {
			// Linux: ~/.local/share/Cline/MCP
			mcpServersDir = path.join(os.homedir(), ".local", "share", "dorjear-code", "MCP")
		}
		...
		try {
			...
			return path.join(os.homedir(), ".dorjear-code", "mcp")
		}
	...
	public async getTelemetryProperties(): Promise<TelemetryProperties> {
		...
		// Get Dorjear Code Cloud authentication state
