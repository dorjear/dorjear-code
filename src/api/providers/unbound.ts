...
import { unboundDefaultModelId, unboundDefaultModelInfo } from "@dorjear-code/types"
...
const ORIGIN_APP = "dorjear-code"

const DEFAULT_HEADERS = {
	"X-Unbound-Metadata": JSON.stringify({ labels: [{ key: "app", value: "dorjear-code" }] }),
}
