...
- Add IPC types to dorjear-code.d.ts
...
- You can now toggle the `terminal.integrated.inheritEnv` VSCode setting directly for the Dorjear Code settings (thanks @KJ7LNW)
...
- Fix a nasty bug that would cause Dorjear Code to hang, particularly in orchestrator mode
...
- Simplify and streamline Dorjear Code's quick actions
- Allow Dorjear Code settings to be imported from the welcome screen (thanks @julionav)
...
- Focus Dorjear Code in the sidebar when running tasks in the sidebar via the API
- Improve subtasks UI
...
- Add command to focus Dorjear Code input field (thanks @axkirillov!)
...
- Allow processes to access the Dorjear Code API via a unix socket
...
- Add an activation command that other extensions can use to interface with Dorjear Code (thanks @gtaylor!)
...
- Internationalize Dorjear Code into Catalan, German, Spanish, French, Hindi, Italian, Japanese, Korean, Polish, Portuguese, Turkish, Vietnamese, Simplified Chinese, and Traditional Chinese (thanks @feifei325!)
...
- Add opt-in telemetry to help us improve Dorjear Code faster (thanks Cline!)
...
- Add support for a .rooignore to prevent Dorjear Code from read/writing certain files, with a setting to also exclude them from search/lists (thanks Cline!)
...
- Add a new “Human Relay” provider that allows you to manually copy information to a Web AI when needed, and then paste the AI's response back into Dorjear Code (thanks @NyxJae)!
...
- Fix context window truncation math (see [#1173](https://github.com/RooCodeInc/dorjear-code/issues/1173))
...
- Introducing Dorjear Code 3.7, with support for the new Claude Sonnet 3.7. Because who cares about skipping version numbers anymore? Thanks @lupuletic and @cte for the PRs!
...
- New Dorjear Code community Discord at https://roocode.com/discord!
...
- **Name Change From Roo Cline to Dorjear Code:** We're excited to announce our new name! After growing beyond 50,000 installations, we've rebranded from Roo Cline to Dorjear Code to better reflect our identity as we chart our own course.

- **Custom Modes:** Create your own personas for Dorjear Code! While our built-in modes (Code, Architect, Ask) are still here, you can now shape entirely new ones:
...
- This release adds chat modes! Now you can ask Dorjear Code questions about system architecture or the codebase without immediately jumping into writing code. You can even assign different API configuration profiles to each mode if you prefer to use different models for thinking vs coding. Would love feedback in the new Dorjear Code Reddit! https://www.reddit.com/r/RooCode
...
- Incorporate Premshay's [PR](https://github.com/RooCodeInc/dorjear-code/pull/60) to add support for Amazon Nova and Meta Llama Models via Bedrock (3, 3.1, 3.2) and unified Bedrock calls using BedrockClient and Bedrock Runtime API
...
- Incorporate dbasclpy's [PR](https://github.com/RooCodeInc/dorjear-code/pull/54) to add support for gemini-exp-1206
...
- Fix https://github.com/RooCodeInc/dorjear-code/issues/50 where sound effects were not respecting settings
...
- Incorporate lloydchang's [PR](https://github.com/RooCodeInc/dorjear-code/pull/42) to add support for OpenRouter compression
