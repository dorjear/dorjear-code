		...
		const generatedPackageJson = generatePackageJson({
			packageJson: {
				...
				contributes: {
					...
					views: {
						"dorjear-cline-ActivityBar": [
							{
								type: "webview",
								id: "dorjear-cline.SidebarProvider",
								name: "",
							},
						],
					},
					commands: [
						{
							command: "dorjear-cline.plusButtonClicked",
							title: "%command.newTask.title%",
							icon: "$(add)",
						},
						{
							command: "dorjear-cline.openInNewTab",
					...
					menus: {
						"editor/context": [
							{
								submenu: "dorjear-cline.contextMenu",
								group: "navigation",
							},
						],
						"dorjear-cline.contextMenu": [
							{
								command: "dorjear-cline.addToContext",
								group: "1_actions@1",
							},
						],
						"editor/title": [
							{
								command: "dorjear-cline.plusButtonClicked",
								group: "navigation@1",
								when: "activeWebviewPanelId == dorjear-cline.TabPanelProvider",
							},
							{
								command: "dorjear-cline.settingsButtonClicked",
								group: "navigation@6",
								when: "activeWebviewPanelId == dorjear-cline.TabPanelProvider",
							},
							{
								command: "dorjear-cline.accountButtonClicked",
								group: "navigation@6",
								when: "activeWebviewPanelId == dorjear-cline.TabPanelProvider",
							},
						],
					...
					submenus: [
						{
							id: "dorjear-cline.contextMenu",
							label: "%views.contextMenu.label%",
						},
						{
							id: "dorjear-cline.terminalMenu",
					...
					configuration: {
						...
						properties: {
							...
							"dorjear-cline.customStoragePath": {
								type: "string",
								default: "",
			...
			substitution: ["dorjear-cline", "dorjear-code-nightly"],
		})
