...
By default a evals run will run all programming exercises in [Dorjear Code Evals](https://github.com/RooCodeInc/dorjear-code-Evals) repository with the Claude Sonnet 4 model and default settings. For basic configuration you can specify the LLM to use and any subset of the exercises you'd like. For advanced configuration you can import a Dorjear Code settings file which will allow you to run the evals with Dorjear Code configured any way you'd like (this includes custom modes, a footgun prompt, etc).
...
- Optionally builds and installs the Dorjear Code extension from source
